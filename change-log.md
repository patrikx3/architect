...
* REFACTOR: Simplify agent architecture and consolidate role definitions.

### v2026.4.116
Released on 05/11/2026
* BUGFIX: Pass codex prompt via stdin to dodge OS ARG_MAX (E2BIG) on large prompts.

### v2026.4.115
Released on 05/11/2026
* BUGFIX: Scout is now fully stack-agnostic with zero stack-specific keywords in the prompt.

### v2026.4.114
Released on 05/11/2026
* BUGFIX: Improved null-byte safety with full-buffer binary detection and provider-side scrubbing.
...
### v2026.4.111
Released on 05/11/2026
* BUGFIX: Never silently overwrite "modify" files when content was not embedded in the scan.
